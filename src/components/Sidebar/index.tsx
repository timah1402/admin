    ...
    menuItems: [
      {
        ...
        label: <div className="">Dashboard</div>,
        route: "/",
      ...
      {
        icon: <FaRegFolder />,
        label: <div className="">New Requests</div>,
        route: "/NewRequest",
        // children: [{ label: "Dashboard", route: "/" }],
      },
      {
        icon: <FaRegMessage />,
        label: <div className="">Messages</div>,
        route: "",
        // children: [{ label: "Dashboard", route: "/" }],
      },

      {
        ...
        label: <div className="">Profile</div>,
        route: "/profile",
      },
    ...
    menuItems: [
      {
        ...
        children: [
          {
            label: <div className="">Sign In</div>,
            route: "/auth/signin",
          },
          {
            label: <div className="">Sign Up</div>,
            route: "/auth/signup",
          },
        ],
      },
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            <div className="items-centers flex justify-between gap-2 text-white">
              ...
              <h1 className="flex  items-center text-2xl font-bold text-black-2 dark:text-white">
                Admin Panel{" "}
              </h1>
            </div>
          </Link>
